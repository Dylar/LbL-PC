...
public class MainGui extends JFrame implements ActionListener {
	...
	private JPanel deviceInformation() {
		...
		JLabel deviceName = new JLabel("Ger�tename: ");
	...
	public void actionPerformed(ActionEvent e) {// TODO Das ganze kann bzw soll in den controller... in der GUIkeine "logik" sondern nur infos für den controller(also das command enfch eeitercgebb ) guck dir dss beim clientact und controller in der app an
